    ...
    <div className="mx-auto max-w-4xl">
      ...
      <FadeIn>
        <div className="mb-16 max-w-3xl space-y-4 text-muted-foreground leading-relaxed">
          <p>
            ...
            to complex enterprise systems that handle millions of transactions.
          </p>
          <p>
            Whether you&apos;re a startup building your first MVP, an enterprise
            modernising legacy systems, or an established business looking for a
            WordPress redesign or custom e-commerce solution — we bring the same
            rigour to every project. Our founder is personally involved from
            first conversation to launch day, which means no handoff gaps
            between sales and engineering.
          </p>
          <p>
            We specialise in React, Next.js, Node.js, and the modern JavaScript
            ecosystem, but we&apos;re not limited to it. We ship production
            software in Python, PHP, .NET, Rust, Swift, Kotlin, and Flutter.
            We&apos;ve built on WordPress, Shopify, WooCommerce, Webflow, and
            every major cloud platform including AWS, Google Cloud, Azure,
      ...
      <FadeIn>
        <div className="mb-6">
          ...
          <p className="mt-2 text-muted-foreground text-sm">
            We work with 70+ technologies across the full stack. Each page below
            explains what we build with that technology, the challenges
      ...
      <FadeIn>
        <section className="mb-16 max-w-3xl space-y-4 text-muted-foreground text-sm leading-relaxed">
          ...
          <p>
            We&apos;re not a body shop or a freelance marketplace. A Major is a
            focused software agency where the founder personally oversees every
            project. That means direct communication with the person making
            technical decisions, not a project manager relaying messages between
            you and an anonymous team.
          </p>
          <p>
            Our clients range from pre-seed startups shipping their first MVP to
            established enterprises modernising decade-old platforms. We work
            across healthcare, fintech, e-commerce, education, logistics, and
            SaaS — bringing cross-industry perspective to every project we take
            on.
          </p>
          <p>
            Based in Singapore and serving clients worldwide, we combine
            Southeast Asian pragmatism with global engineering standards. Every
            project ships with clean code, proper documentation, CI/CD
