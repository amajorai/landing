...
export const LaserFlow: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    setSizeNow();
    // Force a second size check after the first paint — Next.js client-side
    // navigation can cause the container to have 0 dimensions on initial mount.
    const mountRaf = requestAnimationFrame(setSizeNow);
